...
<nav class="mt-5 bg-white" aria-label="Sidebar">
  <a href="#" class="bg-gray-100 text-gray-900 hover:text-gray-900 hover:bg-gray-100 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
    <svg class="text-gray-500 mr-3 flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
  ...
  <a href="#" class="text-gray-600 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-gray-400 group-hover:text-gray-500 mr-3 flex-shrink-0 h-6 w-6" style="--arc-background-gradient-color0:#BCB8A7FF; --arc-palette-background:#EEEDECF4; --arc-palette-title:#1D1B16F6; --arc-palette-cutoutColor:#EFEEEAFF; --arc-background-gradient-color1:#A7ABBCFF; --arc-palette-hover:#DDDCD8F5; --arc-palette-subtitle:#BCBAB3F7; --arc-palette-backgroundExtra:#FDFDFDF2; --arc-palette-foregroundTertiary:#EFEEEAFF; --arc-palette-maxContrastColor:#5C5846FF; --arc-palette-focus:#ABA9A0F9; --arc-palette-minContrastColor:#EFEEEAFF; --arc-palette-foregroundPrimary:#BCB8A7FF; --arc-palette-foregroundSecondary:#BCB8A7FF;"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
